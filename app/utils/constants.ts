...
export const COLORMATRIX_BLACK_TRANSPARENT = [1, 0, 0, 0, 1,  // Red stays the same
    0, 1, 0, 0, 1,  // Green stays the same
    0, 0, 1, 0, 1,  // Blue stays the same
    30, 30, 30, 0, -255 ];  // Alpha channel: Reduce alpha if the pixel is dark (near black)];
